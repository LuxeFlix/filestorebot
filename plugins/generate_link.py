...
ALL_COMMANDS = ["start", "set_db", "set_log", "add_admin", "del_admin", "mode", "batch", "cancel", "add_fsub", "del_fsub", "fsub_list", "req_fsub", "auto_delete", "set_delete", "stats", "broadcast", "dbroadcast", "ban", "unban", "unban_all", "settings", "add_credit", "remove_credit", "shortlink", "set_shortlink", "set_tutorial", "plan", "premium", "buy", "set_pay", "add_prem", "del_prem", "set_owner_link", "set_group_link", "set_free_limit", "status", "delete", "migrate_db"]
